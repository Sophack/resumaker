...
const ResumeFields = memo(
  ({
    ...
    console.log("Builder 18", personalState);
    console.log("Builder 19", workState);
    console.log("Builder 20", skillsState);
    ...
    }, [personalState, workState, skillsState]);
    ...
    const handleSubmit = (event) => {
      ...
      try {
        ...
        console.log("builderResumeCL", resume);
              ...
              <div className="form-box">
                <FormControl style={{ width: "90%" }}>
                  <TextField
                    ...
                    onChange={(event) =>
                      handlePersonalChange(event, "fullName")
                    }
                  ...
                  <TextField
                    ...
                    onChange={(event) =>
                      handlePersonalChange(event, "location")
                    }
                    InputLabelProps={{ shrink: true }}
                    style={{ marginTop: "20px" }}
                  />
                  ...
                  <TextField
                    ...
                    onChange={(event) =>
                      handlePersonalChange(event, "objective")
                    }
                    InputLabelProps={{ shrink: true }}
                    style={{ marginTop: "20px" }}
                  />
              ...
              <div className="form-box">
                <FormControl style={{ width: "90%" }}>
                  ...
                  <TextField
                    ...
                    onChange={(event) =>
                      handleEducationChange(event, "program")
                    }
                    InputLabelProps={{ shrink: true }}
                    style={{ marginTop: "20px" }}
                  />
              ...
              <div className="form-box">
                <FormControl style={{ width: "90%" }}>
                  ...
                  <TextField
                    ...
                    onChange={(event) => handleSkills(event, "transferableSkills")}
                    InputLabelProps={{ shrink: true }}
                    style={{ marginTop: "20px" }}
                  />
                  <Button
